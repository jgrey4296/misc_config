...
(setq-default tidal-interpreter "/usr/local/bin/ghci"
              ...
              sclang-library-configuration-file (expand-file-name "modules/jg-music-layer/sclang.yaml" doom-local-dir)
              sclang-udp-port 57120
              sclang-eval-line-forward nil
              sclang-runtime-directory (expand-file-name "~/.sclang/")
              sclang-boot-file (expand-file-name "modules/jg-music-layer/startup.scd" doom-local-dir)
