...
(setq-default +lookup-definition-functions      nil
              +lookup-declaration-functions     nil
...
(spec-handling-new! lookup-handler nil :loop 'hook
                    ...
                    (setq-local +lookup-assignments-functions     (cl-remove-duplicates (append (ensure-list (plist-get val :assignments))        +lookup-assignments-functions))
                                +lookup-definition-functions      (cl-remove-duplicates (append (ensure-list (plist-get val :definition))         +lookup-definition-functions))
                                +lookup-declaration-functions      (cl-remove-duplicates (append (ensure-list (plist-get val :declaration))       +lookup-declaration-functions))
