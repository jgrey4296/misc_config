...
;;;###autoload (autoload '+jg-text-visual-contract "evil-text-obj" nil t)
...
;;;###autoload (autoload '+jg-text-grow-selection-op "evil-text-obj" nil t)
...
;;;###autoload (autoload '+jg-text-line-textobj "evil-text-obj" nil t)
...
;;;###autoload (autoload '+jg-text-whole-buffer-textobj "evil-text-obj" nil t)
...
;;;###autoload (autoload '+jg-text-blank-block "evil-text-obj" nil t)
...
;;;###autoload (autoload '+jg-text-spaces "evil-text-obj" nil t)
