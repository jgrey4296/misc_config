...
(speckler-add! online-search ()
  :override t
  '(defaults
    ("DuckDuckGo"         #'librarian--backend---online-duckduckgo)
    ("DDG Raw"            "https://duckduckgo.com/?q=%s")
...
(speckler-add! online-search ()
  :override t
  '(plus
    ("Google"             #'librarian--backend---online-google)
    ("GoogleRaw"          "https://google.com/search?q=%s")
