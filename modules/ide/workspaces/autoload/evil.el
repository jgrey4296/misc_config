...
;;;###autoload (autoload '+workspace:save "ide/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:load "ide/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:new "ide/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:rename "ide/workspaces/autoload/evil" nil t)
(evil-define-command +workspace:rename (new-name)
  "Ex wrapper around `+workspace/rename'."
  (interactive "<a>") (+workspace/rename new-name))

;;;###autoload (autoload '+workspace:delete "ide/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:switch-next "ide/workspaces/autoload/evil" nil t)
...
;;;###autoload (autoload '+workspace:switch-previous "ide/workspaces/autoload/evil" nil t)
