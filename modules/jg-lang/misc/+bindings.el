...
(map! :map groovy-mode-map
      :localleader
      :desc "Docs: Gradle"   "1" (cmd! (browse-url "https://docs.gradle.org/current/userguide/userguide.html"))
      :desc "Docs: Groovy"   "2" (cmd! (browse-url "https://groovy-lang.org/documentation.html"))
      )
