...
(speckler-add! file-templates ()
  '(rust
    ("config\\.toml'"  :trigger "__cargo_config"     :mode toml-mode)
    ("Cargo\\.toml'"   :trigger "__cargo"            :mode toml-mode)
    ...
    ("\\.rs'"          :trigger "__"                 :mode rust-mode)
    (rustic-mode       :trigger "__"            :priority -199)
    (rust-mode         :trigger "__"            :priority -199)
    )
  )
