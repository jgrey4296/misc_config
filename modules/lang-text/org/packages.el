...
;;; Babel
(package! ob-async)
(package! ob-clojure-literate :recipe (:type git :host nil :repo "https://repo.or.cz/ob-clojure-literate.el.git"))
(package! ob-crystal)
(package! ob-elixir)
...
(package! ob-hy)
(package! ob-nim)
(package! ob-php :recipe (:type git :host nil :repo "https://repo.or.cz/ob-php.git"))
