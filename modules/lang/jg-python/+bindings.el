...
(map! :after python
      ...
      :desc "Docs: PyPi"          "2" (cmd! (+jg-browse-url (s-concat "https://pypi.org/" (let ((lib (read-string "Library: ")))
                                                                                            (if (s-blank? lib) nil (format "search/?q=%s" lib))))))
      (:prefix ("3" . "Lib Docs")
       :desc "Docs: Bibtex Parser" "1" (cmd! (+jg-browse-url jg-python-bibtex-parser-url))
       :desc "Docs: BeautifulSoup" "2" (cmd! (+jg-browse-url jg-python-beautiful-soup-url))
       :desc "Docs: PyRight"       "3" (cmd! (+jg-browse-url "https://github.com/Microsoft/pyright"))
       :desc "Docs: Z3"            "4" (cmd! (+jg-browse-url "https://github.com/Z3Prover/z3"))
       :desc "Docs: Sorobn"        "5" (cmd! (+jg-browse-url "https://github.com/MaxHalford/sorobn"))
       :desc "Docs: Pomegranate"   "6" (cmd! (+jg-browse-url "https://pomegranate.readthedocs.io/en/latest/"))
       :desc "Docs: Pgmpy"         "7" (cmd! (+jg-browse-url "https://pgmpy.org/"))
       :desc "Docs: Rich"          "0" (cmd! (+jg-browse-url "https://rich.readthedocs.io/en/stable/introduction.html"))
       )
      (:prefix ("4" . "Data Science Docs")
       :desc "Docs: FlowWeaver"    "1" (cmd! (+jg-browse-url "https://floweaver.readthedocs.io/en/latest/"))
       :desc "Docs: Matplotlib"    "2" (cmd! (+jg-browse-url "https://matplotlib.org/stable/contents.html"))
       :desc "Docs: Numpy"         "3" (cmd! (+jg-browse-url "https://numpy.org/doc/stable/"))
       :desc "Docs: Pandas"        "4" (cmd! (+jg-browse-url "https://pandas.pydata.org/docs/"))
       :desc "Docs: Seaborn"       "5" (cmd! (+jg-browse-url "https://seaborn.pydata.org/api.html"))
       )
      (:prefix ("5" . "Database")
       :desc "Docs: Pony"           "1" (cmd! (+jg-browse-url "https://github.com/ponyorm/pony/"))
       :desc "Docs: Marshmallow"    "2" (cmd! (+jg-browse-url "https://marshmallow.readthedocs.io/en/stable/"))
       :desc "Docs: pylightxl"      "3" (cmd! (+jg-browse-url "https://github.com/PydPiper/pylightxl"))
       :desc "Docs: pyexcel"        "4" (cmd! (+jg-browse-url "https://github.com/pyexcel/pyexcel"))
      )
      (:prefix ("0" . "Packaging Docs")
       :desc "Docs: Setuptools"    "1" (cmd! (+jg-browse-url "https://setuptools.readthedocs.io/en/latest/userguide/index.html"))
       :desc "Docs: Conda Env"     "2" (cmd! (+jg-browse-url "https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html"))
      )
)
