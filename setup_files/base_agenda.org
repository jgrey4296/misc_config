* Base Agenda
  ...
  :END:
** TODO [[file:~/github/cairo_pipeline/institution.org::*Institution%20Pipeline%20Concept][Institution Pipeline Concept]]
...
*** TODO [[~/.spacemacs.d/layers/trie][Trie-layer]]
    [[file:~/github/cairo_pipeline/institution.org::*Institution%20Pipeline%20Concept][Institution Pipeline Concept]]
**** Components
***** Emacs Components
****** Pipelang Mode
       For Writing Institutions.
       Can trigger [[file:base_agenda.org::*Rule%20Writing%20Mode%20(RWM)][EM]] and [[file:base_agenda.org::*Explore%20Mode%20(EM)][Explore Mode (EM)]]
